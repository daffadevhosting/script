...
(function (e, t) {
    var n = typeof "",
        ...
        h = function (n) {
            ...
            var cart_kosong = '<div class="empty-cart"><i class="fa fa-shopping-basket" style="font-size: 50px;"></i><span class="keranjang-kosong">Keranjang Belanja kosong</span><div class="cartUcihaItachi"></div></div>';
            var r = { MooTools: "$$", Prototype: "$$", jQuery: "*" },
                i = 0,
                s = "SCI-",
                o = {},
                p = n || "simpleCart",
            ...
            N.extend({
                writeCart: function (e) {
                    var t = T.cartStyle.toLowerCase(),
                        ...
                        h,
                        p;
                       $(".ck-btn,.basket-detail,.harga-total,#total-harga,.right_side,.lisQdaffadev").hide();
                       $(".keranjang-kosong").show();
                    a.html(" ").append(o);

                    o.append(cart_kosong);
                ...
                createCartRow: function (e, t, n, r, i) {
                    var s = N.$create(n)
                            .addClass("itemRow row-" + t + " " + (t % 2 ? "even" : "odd"))
                            .attr("id", "cartItem_" + e.id()),
                        o,
                        a,
                        f,
                        l,
            ...
            N.Item._ = N.Item.prototype = {
                ...
                price: function (e) {
                    return a(e)
                        ? parseFloat(this.get("price", true).toString().replace(N.currency().symbol, "").replace(N.currency().delimiter, "") || 1)
                        : this.set("price", parseFloat(e.toString().replace(N.currency().symbol, "").replace(N.currency().delimiter, "")));
                },
                id: function () {
            ...
            N.extendCheckout({
                PayPal: function (e) {
                    ...
                    var t = { cmd: "_cart", upload: "1", currency_code: N.currency().code, business: e.email, rm: e.method === "GET" ? "0" : "2", tax_cart: N.tax(), handling_cart: N.shipping(), charset: "utf-8" },
                    ...
                    N.generateAndSendForm({ action: n, method: r, data: t });
                },
                GoogleCheckout: function (e) {
                    ...
                    var t = { ship_method_name_1: "Shipping", ship_method_price_1: N.shipping(), ship_method_currency_1: N.currency().code, _charset_: "" },
                ...
                AmazonPayments: function (e) {
                    ...
                    var t = { aws_access_key_id: e.aws_access_key_id, merchant_signature: e.merchant_signature, currency_code: N.currency().code, tax_rate: N.taxRate(), weight_unit: e.weight_unit || "lb" },
                ...
                SendForm: function (e) {
                    ...
                    var t = { currency: N.currency().code, shipping: N.shipping(), tax: N.tax(), taxRate: N.taxRate(), itemCount: N.find({}).length },
                        n = e.url,
                        r = e.method === "GET" ? "GET" : "POST";
                    N.each(function (e, n) {
                        var r = n + 1,
            ...
            N.extend({
                toCurrency: function (e, t) {
                    var n = parseFloat(e),
                        r = t || {},
                        i = N.extend(N.extend({ symbol: "$", decimal: "", delimiter: ".", accuracy: 0, after: false }, N.currency()), r),
                        s = n.toFixed(i.accuracy).split("."),
                        o = s[1],
                        u = s[0];
...
(function () {
    ...
    if (typeof JSON.stringify !== "function")
        JSON.stringify = function (t, r, s) {
            var o;
            n = e = "";
            if (typeof s === "number") for (o = 0; o < s; o += 1) n += " ";
